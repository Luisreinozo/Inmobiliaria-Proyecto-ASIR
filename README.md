...
- **ASXBD**: creación de BBDD y contenedores.
- **IAW**: configuración y publicación del servidor web.
- **ASO**: gestión de usuarios, grupos y políticas de acceso.
- **SAD**: configuración de firewall, VPN y políticas de backup.
